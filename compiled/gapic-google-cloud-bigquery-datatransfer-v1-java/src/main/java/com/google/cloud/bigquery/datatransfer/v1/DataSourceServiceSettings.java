...
public class DataSourceServiceSettings extends ClientSettings<DataSourceServiceSettings> {
  ...
  public PagedCallSettings<ListLocationsRequest, ListLocationsResponse, ListLocationsPagedResponse>
    ...
    return ((DataSourceServiceStubSettings) getStubSettings()).listLocationsSettings();
  }

  /** Returns the object with the settings used for calls to getLocation. */
  public UnaryCallSettings<GetLocationRequest, Location> getLocationSettings() {
    return ((DataSourceServiceStubSettings) getStubSettings()).getLocationSettings();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return DataSourceServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static class Builder extends ClientSettings.Builder<DataSourceServiceSettings, Builder> {
    ...
    private static Builder createHttpJsonDefault() {
      return new Builder(DataSourceServiceStubSettings.newHttpJsonBuilder());
    }
