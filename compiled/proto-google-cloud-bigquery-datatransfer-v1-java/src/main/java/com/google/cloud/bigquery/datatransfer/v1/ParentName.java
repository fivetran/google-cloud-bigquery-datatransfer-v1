...
public class ParentName implements ResourceName {
  ...
  public static ParentName parse(String formattedString) {
    ...
    throw new ValidationException("ParentName.parse: formattedString not in valid format");
  }
  ...
  public static class Builder {
    ...
    private Builder(ParentName parentName) {
      Preconditions.checkArgument(
          Objects.equals(parentName.pathTemplate, PROJECT),
          "toBuilder is only supported when ParentName has the pattern of projects/{project}");
